	...
	<script type="text/javascript">
	   ...
	   if(ua.indexOf("iphone") != -1 || ua.indexOf("ipad") != -1 || (ua.indexOf("android") != -1 && !flashInstalled)){
	      ...
	      if(!flashInstalled){
	         ...
	         new swfobject.embedSWF("'.$this->swfUrl.'", "'.$this->id.'", "'.(int)$this->width.'", "'.(int)$this->height.'", "10.0.0", false, flashvars, params);
	...
	<script type="text/javascript">
	   ...
	   if(ua.indexOf("iphone") != -1 || ua.indexOf("ipad") != -1 || (ua.indexOf("android") != -1 && !flashInstalled)){
	      ...
	      if(!flashInstalled){
	         ...
	         var flashvars = {"file":"'.$this->video.'"};
	         var params = {bgcolor:"'.$bgcolor.'",  allowFullScreen:"true", allowScriptAccess:"always",id:"'.$this->id.'"};
	         new swfobject.embedSWF("'.$this->swfUrl.'", "'.$this->id.'", "640", "480", "10.0.0", false, flashvars, params);
